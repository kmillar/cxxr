...
namespace rho {
  typedef RObject*(ArgListBuiltin)(Expression*,
                                  const BuiltInFunction*,
                                  Environment* env,
                                  const ArgList& args);
  typedef RObject*(VarArgsBuiltin)(Expression*,
                                   const BuiltInFunction*,
                                   int num_args,
                                   ...);
}  // namespace rho
...
rho::ArgListBuiltin do_asatomic;
...
rho::ArgListBuiltin do_duplicated;
...
rho::ArgListBuiltin do_identical;
...
rho::ArgListBuiltin do_invisible;
...
rho::ArgListBuiltin do_rank;
rho::ArgListBuiltin do_rapply;
...
rho::ArgListBuiltin do_seq_along;
...
rho::ArgListBuiltin do_sprintf;
rho::ArgListBuiltin do_standardGeneric;
...
rho::ArgListBuiltin R_do_data_class;
...
rho::ArgListBuiltin do_provCommand;
SEXP do_provenance(SEXP, SEXP, SEXP, SEXP);  // Special
rho::ArgListBuiltin do_provenance_graph;
